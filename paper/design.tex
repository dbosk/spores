...
The information brought by these overlays allows devices to securely and reliably exchange messages between users by creating Predictive Onion Routes (PORs), as will be explained in section~\ref{sec:message_passing}.
