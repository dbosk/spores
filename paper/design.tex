...
PORs are our adaptation of onion routes, allowing secret communication between two entities despite the unreliability of the nodes that will relay their messages.
