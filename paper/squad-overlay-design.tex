...
To model the user's behavior (and predict its future activity), we employ discrete Hidden Markov Models (HMMs) of order one, with multiple discrete observation processes (the devices connection). 
