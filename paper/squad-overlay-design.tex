...
Now we will consider a slightly different scenario.
...
\subsubsection{Computing the availability function}

\dots

\subsubsection{Reassembly across the e-squad}

\dots

\endinput

\commentDaniel{The stuff below is Adrien's old stuff.}
