...
% Every time Bob successfully receives a chunk $\chunk_i$, \recdevice sets the bit $\bitfield[i]$, 
% To acknowledge the chunk's reception, \recdevice sends \bitfield back to Alice, through a unique route $\mathcal{H}'_{\chunk_i}$.
