...
We show in section~\ref{sub:predictive_onion_routes_creation} that the prediction of devices' availability at $t+1$ is a good enough estimator of their connection state at $t+i$.
