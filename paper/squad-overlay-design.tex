...
For that reason, devices only compute the prediction of their connection at $t+1$, that is considered a good enough estimator of their state ``in the near future''.
