...
This information is used when any node needs to create a Stateless Predictive Probabilistic Onion Route (\acs{SPOR}).%, as will be shown in the next subsection~\ref{ssec:por}.
