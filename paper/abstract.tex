...
\sonja{say something about security requirements? About sphinxes?} \commentFT{Added a mention to SphinxES, not sure if we can discuss security requirements without making the abstract overly long.}
