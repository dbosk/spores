...
%approach
In this paper, we demonstrate that a fully-decentralized data-sharing solution that is  both efficient and strongly private is possible.
\commentFT{Trying to highlight POR, as likely to be catch people's attention, and contribute to the paper's long-term interest.} At the core of our proposal lies a novel probabilistic onion routing protocol called POR, which exploits decentralized peer sampling, and a probabilistic model of node availability. \commentFT{Sharing node availability information freely could potentially disclose private information. We might want to discuss this risk somewhere in the paper.}
