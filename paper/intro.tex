...
adversary model the desired privacy properties of \name. Section~\ref{design}
introduce the design of our proposed solution. Section~\ref{Performance}
evaluates the proposed approach. In Section~\ref{security-discussion}, we lead a security discussion
about advantages, shortcomings of our approach.
