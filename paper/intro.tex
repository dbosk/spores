...
User devices become tracking and/or monitoring \squad{}s that turn out
to be the best spy over users. 
...
in terms of both data \emph{and} metadata. Our proposal hinges on two
key ideas: \emph{First},  the recent advances of smartphones and other
mobile devices enable e-squads and it has thus
become possible to benefit from P2P technology for one's own devices
alone, thereby reducing one's exposure to security and privacy threats
from third parties. Relatedly, we consider proxemics relationships as a key enabler to initiate file
...
predictive nature of our routing, exploited in a stateless way, allows us to overcome the inherent
fragility of pure P2P data-sharing schemes. 
