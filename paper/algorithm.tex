...
\begin{figure}
  \begin{algorithmic}
    \Require{%
      $D$ is the set of alternative destination devices,
    ...
    \Function{\GetRouteNode}{$\theta$}
      ...
      \While{$\prod_{d\in D} \Pr[d \text{ offline}] > \theta$}
...
\begin{figure}
  \begin{algorithmic}
    \Require{%
      ...
      $H_\rdv$ is the onion-route given by the recipient (its first node is the 
      rendez-vous point).
    }
...
\commentDaniel{Anything below this line should be updated.}
