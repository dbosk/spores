...
\begin{itemize}
  ...
  \item \(\avail_d\) is the node's probability of being online in the near future. It computation will be discussed in~\ref{ssec:device_availability}.
\end{itemize}
...
Using $\theta$, \name becomes more conservative than \SPOR, and we can investigate the best number of nodes per layer in regard of its probability of being available.