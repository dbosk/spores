...
The main concern, shared with traditional P2P file sharing, is churn~\cite{dhtchurn} and its effect on availability. % - here in the narrow context of the set of user devices based on user behavior. 
