...
\commentAL{``Alice and Bob want to exchange a file secretly: no participant should learn who sends and receives it, nor its content.'' (I put that in the Algorithm section for now, but should come here)}
