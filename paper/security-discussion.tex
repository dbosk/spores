...
\cref{system-model}).
Bob is allowed to infer the behaviour of devices in the global set, % Global Device Retinue, 
...
\commentDaniel{If Bob wraps Alice's route, then Alice can use \(g^x\) to track 
  Bob.}
