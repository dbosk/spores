...
As long as we output all the nodes in the next layer, the results for
the adversary are the same: the adversary learns the entire
composition of the layer regardless of whether the set contains a
