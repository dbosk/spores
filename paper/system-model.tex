...
challenge onion \david{what is a challenge onion?} to a router and able to see the outcome of how the
...
<<<<<<< HEAD
is UC-secure \david{what does it means, it has never been introduced
...
can be infered through \name. \sonja{insert more formal definition
