...
\begin{figure}[t]
  \centering
  %\def\svgwidth{0.8\columnwidth}
  \includegraphics[width=0.8\columnwidth]{figures/bw.pdf}

  \caption{\label{fig:bw}Median outbound traffic per node per second over a whole experiment.}
\end{figure}
...
\begin{figure}[t]
  \centering
  %\def\svgwidth{0.8\columnwidth}
  \includegraphics[width=0.8\columnwidth]{figures/bw_mean.pdf}

  \caption{\label{fig:bw_mean}Mean outbound traffic per node per second over the same experiment as figure~\ref{fig:bw}.}
\end{figure}
