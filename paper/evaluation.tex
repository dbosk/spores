...
\begin{figure}[t]
  ...
  \caption{\label{fig:bw_and_pending_files}In gray: number of pending file exchanges; in black: mean outbound traffic (kB) per node per second.}
\end{figure}
...
\begin{figure}[t]
  ...
  \caption{\label{fig:bw_and_pending_files_log}In gray: number of pending file exchanges; in black: mean outbound traffic (kB) per node per second.}
\end{figure}
